...
The OpenThread implementation of the Thread protocol supports all features defined in the Thread 1.4.0 Specification that are required for the Thread 1.3 Certification program:
...
For more information about this Thread version, see the official `Thread 1.4.0 Features White Paper`_.
...
The entity collecting Thread diagnostic information may be directly connected itself to a Thread network, for example situated on a Thread 1.4 Border Router.
