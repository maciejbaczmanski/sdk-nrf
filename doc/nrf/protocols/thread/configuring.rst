...
The :file:`logging.conf` configuration file in the :file:`snippets/logging/` directory of the sample enables :ref:`ug_logging_backends_rtt` as the logging backend by default.
