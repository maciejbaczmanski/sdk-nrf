...
* Added:
  ...
  * The :kconfig:option:`CONFIG_NCS_SAMPLE_MATTER_ZAP_FILES_PATH` Kconfig option, which specifies ZAP files location for the application.
    By default the option points to :file:`src/default_zap` directory and can be changed to any path relative to application's location, under which :file:`.zap` file and :file:`zap-generated` directory are located.
...
* Added:
  ...
  * The :kconfig:option:`CONFIG_NCS_SAMPLE_MATTER_ZAP_FILES_PATH` Kconfig option, which specifies ZAP files location for the sample.
    By default the option points to :file:`src/default_zap` directory and can be changed to any path relative to sample's location, under which :file:`.zap` file and :file:`zap-generated` directory are located.
